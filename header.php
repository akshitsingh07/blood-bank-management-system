<nav class="navbar navbar-expand-sm navbar-light bg-light sticky-top">
	<div class="container">
		<a class="navbar-brand" href="index.php"><img src="image/favicon.jpg" width="30" height="30" class="rounded-circle">Official Online Blood Bank</a>
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
				<a class="nav-link btn btn-light" href="abs.php">Available Bloods for Request</a>
            </li>
            <li class="nav-item">
